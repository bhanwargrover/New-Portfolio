    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="max-w-3xl">
          ...
          >
            <h2 className="text-xl md:text-2xl font-medium text-primary-500 mb-2">
              Hello, I'm
            </h2>
            <h1 className="text-4xl md:text-7xl font-bold mb-4 text-slate-900 dark:text-white">
  <span className="block mb-2">Bhanwar Grover</span>
  <span className="block bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
    Full Stack Developer
  </span>
</h1>
            <h3 className="text-2xl md:text-3xl font-semibold mb-6 text-slate-700 dark:text-slate-300">
              Creative Developer & Full Stack Enthusiast
            </h3>
            <p className="text-lg mb-8 text-slate-600 dark:text-slate-400 max-w-2xl">
      ...
      >
        ...
        <motion.div
          className="w-6 h-10 border-2 border-slate-600 dark:border-slate-400 rounded-full flex justify-center pt-2"
          animate={{ y: [0, 10, 0] }}
